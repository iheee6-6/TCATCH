...
<body>
	...
	<div class="content-min-wrap">
		...
		<div class="guide-division" style="text-align: center;">
			...
			<a href="cnotice2.do"  class="on">이용약관</a>
