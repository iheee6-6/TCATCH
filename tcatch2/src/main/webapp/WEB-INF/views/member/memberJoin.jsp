	...
	<form class="form-signin">
        ...
        <table align="center" width="600" height="600">
            ...
            <tr>
					<td>우편번호</td>
					<td>
						<input type="text" name="post" class="postcodify_postcode5" size="10" />
						<button type="button" id="postcodify_search_button">검색</button>
					</td>
				</tr>
				<tr>
					<td>도로명 주소</td>
					<td><input type="text" name="address1" class="postcodify_address" size="30"  value="" /></td>
				</tr>
				<tr>
					<td>상세 주소</td>
					<td><input type="text" name="address2" class="postcodify_extra_info" size="30" value="" /></td>
				</tr>
            <tr>
                    ...
                    </select>-<input id="phone2" name="phone2" maxlength="4" type="text" required />-<input id="phone3" name="phone3" maxlength="4" type="text" required />
                    </td>
                 </tr>
                 <tr>
        ...
        <div class="joinbtn">
            <button class="btn btn-lg btn-primary btn-block2" type="submit">회원가입</button>&emsp;
            <button type="button" class="btn btn-danger" onclick="location.href='home.do'">메인으로</button>
        </div>
    </form>
