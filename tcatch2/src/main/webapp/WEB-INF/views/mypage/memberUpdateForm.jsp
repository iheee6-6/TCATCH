		...
		<div class="main-panel">
			<div class="content" style="margin-top: 20px;">
				...
				<form class="form-signin" action="minsert.do" method="post"
					...
					<h4 class="card-title text-danger" style="float: left; margin-bottom: 30px">
					...
					<table align="center" width="600" height="600">
						<tr>
							<th>이름 *</th>
							<td><input type="text" name="name" size="30" value="${loginUser.userName }" required></td>
						</tr>
						...
						<tr>
							<th>아이디 *</th>
							<td><input type="text" name="id" id="userId" size="30" value="${loginUser.userId }" readonly>
						...
						<tr>
							...
							<td><input type="text" name="post"
								class="postcodify_postcode5" size="10" />
						...
						<tr>
							...
							<td><select id="phone1" name="phone1" required>
								...
								required />-<input id="phone3" name="phone3" maxlength="4"
						...
						<tr>
							...
							<td>
								<div id="email">
									<input name="email" class="emailcheck0" id="text" value="${loginUser.email}">
